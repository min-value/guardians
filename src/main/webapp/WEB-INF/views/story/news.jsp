...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/story/news.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/story/news/loadNews.js"></script>
